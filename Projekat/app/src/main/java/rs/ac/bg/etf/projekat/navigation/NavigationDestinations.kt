...
object destinationInvestigationPage : NavigationDestinations {
    override val route = "destinationInvestigationPage"
}

object destinationMedicalReportPage : NavigationDestinations {
    override val route = "destinationMedicalReportPage"
}

object destinationPatientPage : NavigationDestinations {
...
object destinationLekarskiTestPage : NavigationDestinations {
    override val route = "destinationLekarskiTestPage"
}

object destinationCultsAndSectsPage : NavigationDestinations {
    override val route = "destinationCultsAndSectsPage"
}

object destinationHospitalPage : NavigationDestinations {
    override val route = "destinationHospitalPage"
}

object destinationLocationPage : NavigationDestinations {
    override val route = "destinationLocationPage"
}

object destinationErrorPage : NavigationDestinations {
    override val route = "destinationErrorPage"
}

val navigationDestinations = listOf(
    destinationMainScreen1, destinationMainScreen2,
    destinationCardsPage,
    destinationMissionPage, destinationSettingsPage,
    ...
    destinationInvestigationPage,
    destinationMedicalReportPage,
    destinationPatientPage,
    destinationMedicalStatementPage, destinationLekarskiTestPage,
    destinationCultsAndSectsPage,
    destinationHospitalPage,
    destinationLocationPage, destinationErrorPage
)
